...
png("E:/R/4.Exploratory/Project/ExData_Plotting1/plot1.png", width=480, height=480)
...
### Plot 4
## save to a PNG file with a width of 480 pixels and a height of 480 pixels
png("E:/R/4.Exploratory/Project/ExData_Plotting1/plot4.png", width=480, height=480)
par(mfrow = c(2,2))

# plot1
plot(y, data$Global_active_power, type = "l", xlab="", ylab="Global Active Power")
...
# plot4
plot(y, data$Global_reactive_power, type = "l", xlab="datetime", ylab="Global_reactive_power")
